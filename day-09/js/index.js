...
function updateText(data) {
    ...
    green = data.length === 0 ? 0 : green; //ternary operator
    blue = data.length === 0 ? 0 : blue;

    // Set text string and the color of the element
    text.innerHTML = `There are ${data.length} circles on the page and the 
    average color is rgb(0, ${green}, ${blue}).`;
